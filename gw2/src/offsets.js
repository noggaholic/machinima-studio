...
const offsets = {
  ...
  camera: {
    ...
    ptr: [0x01806044, 0x1d8, 0x0, 0xec, 0x2b8, 0x0],
    lookAt: {
      x: 0x8,
      y: 0xC,
      z: 0x10
    ...
    rendering: {
	      ...
	      byteLength: 0x55
			...
			environment: {
				...
				offset: 0x00BF154E, // MapEnvironment
				byteLength: 0x38
			},
			river: {
				...
				offset: 0x00BF158B, // MapRiveradvance
				byteLength: 0x5B
			},
			under_water: {
				...
				offset: 0x00BF15EB, // MapWaterAdvance
				byteLength: 0x32
			},
			zone: {
				...
				offset: 0x00BF1622, // MapZoneAdvance
				byteLength: 0x37
			},
			lights: {
			...
			terrain: {
				...
				offset: 0x00BF16D4, // MapTrnUpdate
				byteLength: 0x35
			},
			cube_map: {
				...
				offset: 0x00BF170E, // MapCubeMapAdvance
				byteLength: 0x44
			},
			props: {
				...
				offset: 0x00BF1757, // MapPropAdvance
				byteLength: 0x5E
			}
		},
    timeOfDayOriginal: new Buffer([0xF3, 0x0F, 0x11, 0x8E, 0xCC, 0x19, 0x00, 0x00, 0x5E, 0x5D, 0xC2, 0x04]),
    enableTimeOfDay: 0x00BFE27C, // AFTER THIS -> F3 0F10 05 94220301   - movss xmm0,[Gw2.exe+FF2294]
    timeOfDay: 0x19CC,
    unknown: 0x1A20,
