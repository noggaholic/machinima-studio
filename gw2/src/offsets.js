...
const offsets = {
  ...
  camera: {
    ...
    ptr: [0x017E7104, 0x1d8, 0x0, 0xec, 0x2b8, 0x0],
    lookAt: {
      x: 0x8,
      y: 0xC,
      z: 0x10
	...
	advancedView: {
		animation: {
			...
			offset: 0x0065F583, // ViewAdvanceModel
			byteLength: 0x2C
		}
	},
  environment: {
    ...
    rendering: {
	      ...
	      byteLength: 0x55
			...
			environment: {
				...
				offset: 0x00BE771E, // MapEnvironment
				byteLength: 0x38
			},
			river: {
				...
				offset: 0x00BE775B, // MapRiveradvance
				byteLength: 0x5B
			},
			under_water: {
				...
				offset: 0x00BE77BB, // MapWaterAdvance
				byteLength: 0x32
			},
			zone: {
				...
				offset: 0x00BE77F2, // MapZoneAdvance
				byteLength: 0x37
			},
			lights: {
			...
			terrain: {
				...
				offset: 0x00BE78A4, // MapTrnUpdate
				byteLength: 0x35
			},
			cube_map: {
				...
				offset: 0x00BE78DE, // MapCubeMapAdvance
				byteLength: 0x44
			},
			props: {
				...
				offset: 0x00BE7927, // MapPropAdvance
				byteLength: 0x5E
			}
		},
    timeOfDayOriginal: new Buffer([0xF3, 0x0F, 0x11, 0x8E, 0xCC, 0x19, 0x00, 0x00, 0x5E, 0x5D, 0xC2, 0x04]),
    enableTimeOfDay: 0x00BF46CC, // AFTER THIS -> F3 0F10 05 94220301   - movss xmm0,[Gw2.exe+FF2294]
    timeOfDay: 0x19CC,
    unknown: 0x1A20,
