...
const offsets = {
  ...
  environment: {
    ...
    rendering: {
      ...
      environment: {
        ...
        offset: 0x00BDF46E, // MapEnvironment
        byteLength: 0x38
      },
      river: {
        ...
        offset: 0x00BDF4AB, // MapRiveradvance
        byteLength: 0x5B
      },
      under_water: {
        ...
        offset: 0x00BDF50B, // MapWaterAdvance
        byteLength: 0x32
      },
      zone: {
        ...
        offset: 0x00BDF542, // MapZoneAdvance
        byteLength: 0x37
      },
      lights: {
      ...
      terrain: {
        ...
        offset: 0x00BDF5F4, // MapTrnUpdate
        byteLength: 0x35
      },
      cube_map: {
        ...
        offset: 0x00BDF62E, // MapCubeMapAdvance
        byteLength: 0x44
      },
      props: {
        ...
        offset: 0x00BDF677, // MapPropAdvance
        byteLength: 0x5E
      }
    },
    timeOfDayOriginal: new Buffer([0xF3, 0x0F, 0x11, 0x8E, 0xCC, 0x19, 0x00, 0x00, 0x5E, 0x5D, 0xC2, 0x04]),
    enableTimeOfDay: 0x00BEC30C, // AFTER THIS -> F3 0F10 05 94220301   - movss xmm0,[Gw2.exe+FF2294]
    timeOfDay: 0x19CC,
    unknown: 0x1A20,
  ...
  player: {
    ...
    pos: {
      ptr: [0x018830B4, 0x30, 0x1C, 0x98, 0x0],
      noClip: 0xC8,
      groundLevel: 0xc8,
      x: 0xd0,
      y: 0xd4,
    ...
    visualPos: {
      ptr: [0x018830B4, 0x30, 0x1c, 0x50, 0xc, 0x0],
      headingA: 0xF0,
      headingB: 0xF4,
      x: 0xC0,
      y: 0xC4,
