...
const offsets = {
  ...
  camera: {
    original: new Buffer([0xFF, 0x50, 0x0C, 0x5F, 0x5E, 0x5B, 0x5D, 0xC2, 0x0C, 0x00, 0xFF, 0x75, 0x10, 0x8B, 0x0D]),
    ...
    instructions: {
      ...
      patch_1: {
        offset: 0x00681EFA,
        original: new Buffer([0xF3, 0x0F, 0x11, 0x5E, 0x20, 0xF3, 0x0F, 0x11, 0x46, 0x24, 0xF3, 0x0F, 0x11, 0x7E, 0x28]),
      ...
      patch_3: {
        offset: 0x00681DC3,
        original: new Buffer([0xF3, 0x0F, 0x11, 0x5E, 0x08, 0xF3, 0x0F, 0x11, 0x46, 0x0C, 0xF3, 0x0F, 0x11, 0x7E, 0x10]),
        bytecode: new Buffer([0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90, 0x90])
      },
      patch_4: {
        offset: 0x00681D1C,
  ...
  environment: {
    ...
    rendering: {
			audio: {
				original: new Buffer([0x8B, 0x03, 0x8B, 0xCB, 0x6A, 0x00, 0xFF, 0x90, 0x98, 0x00, 0x00, 0x00, 0xFF, 0xB5, 0x60, 0xFF, 0xFF, 0xFF, 0xF3, 0x0F, 0x10, 0x85, 0x64, 0xFF, 0xFF, 0xFF]),
	      ...
	      byteLength: 0x55
			...
			decal: {
				original: new Buffer([0xF3, 0x0F, 0x10, 0x85, 0x78, 0xFF, 0xFF, 0xFF, 0x56, 0x51, 0x8B, 0xC8, 0xF3, 0x0F, 0x11, 0x04, 0x24, 0xFF, 0x52, 0x38]),
				offset: 0x00BF0F82, // MapDecal
				byteLength: 0x67
			},
			environment: {
				original: new Buffer([0xFF, 0xB5, 0x70, 0xFF, 0xFF, 0xFF, 0x8B, 0x8D, 0x74, 0xFF, 0xFF, 0xFF, 0x8D, 0x95, 0x2C, 0xFF, 0xFF, 0xFF, 0xF3, 0x0F, 0x10, 0x85, 0x78, 0xFF, 0xFF, 0xFF, 0x52]),
			...
			under_water: {
				original: new Buffer([0x8B, 0x8D, 0x70, 0xFF, 0xFF, 0xFF, 0x8D, 0x95, 0x7C, 0xFF, 0xFF, 0xFF, 0xF3, 0x0F, 0x10, 0x85, 0x78, 0xFF, 0xFF, 0xFF, 0x52, 0x8D, 0x95, 0x4C, 0xFF, 0xFF, 0xFF, 0x8B, 0x01, 0x52]),
				offset: 0x00BF108B, // MapWaterAdvance
				byteLength: 0x32
			},
			zone: {
				original: new Buffer([0x8B, 0x8D, 0x6C, 0xFF, 0xFF, 0xFF, 0x6A, 0x1B, 0x8D, 0x04, 0x09, 0x8B, 0xCB, 0x89, 0x85, 0x28, 0xFF, 0xFF, 0xFF, 0x8B, 0x03, 0xFF, 0x90]),
				offset: 0x00BF10C2, // MapZoneAdvance
				byteLength: 0x37
			},
			lights: {
				original: new Buffer([0x8B, 0x03, 0x8B, 0xCB, 0x6A, 0x0A, 0xFF, 0x90, 0x98, 0x00, 0x00, 0x00, 0xF3, 0x0F, 0x10, 0x85, 0x68, 0xFF, 0xFF, 0xFF, 0x8D, 0x8D, 0x2C, 0xFF, 0xFF, 0xFF, 0x83, 0xEC, 0x08]),
			...
			terrain: {
				original: new Buffer([0x8B, 0x8D, 0x5C, 0xFF, 0xFF, 0xFF, 0x6A, 0x01, 0xFF, 0xB5, 0x60, 0xFF, 0xFF, 0xFF, 0x8B, 0x01, 0x56, 0x8B, 0xF1, 0xFF, 0x50, 0x14]),
				offset: 0x00BF1174, // MapTrnUpdate
				byteLength: 0x35
			},
			cube_map: {
				original: new Buffer([0x8B, 0x03, 0x8B, 0xCB, 0x6A, 0x04, 0xFF, 0x90, 0x98, 0x00, 0x00, 0x00, 0xF3, 0x0F, 0x10, 0x85, 0x68, 0xFF, 0xFF, 0xFF, 0x83, 0xEC, 0x0C, 0x8B, 0xC8]),
				offset: 0x00BF11AE, // MapCubeMapAdvance
				byteLength: 0x44
			},
			props: {
				original: new Buffer([0x8B, 0x03, 0x8B, 0xCB, 0x6A, 0x10, 0xFF, 0x90, 0x98, 0x00, 0x00, 0x00, 0x8B, 0x13, 0x8B, 0xCB, 0x6A, 0x11, 0x8B, 0xF0, 0xFF, 0x92, 0x98, 0x00, 0x00, 0x00]),
    ...
    timeOfDayOriginal: new Buffer([0xF3, 0x0F, 0x11, 0x86, 0xCC, 0x19, 0x00, 0x00, 0x5E, 0x5D, 0xC2, 0x04, 0x00]),
  ...
  ViewAdvanceModel: {
    original: new Buffer([0x57, 0x51, 0x8B, 0xCE, 0x89, 0x43, 0x04, 0xF3, 0x0F, 0x11, 0x04, 0x24])
  },
  player: {
