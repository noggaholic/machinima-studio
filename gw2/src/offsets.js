  ...
  camera: {
	...
	advancedView: {
		animation: {
			...
			offset: 0x00660643, // ViewAdvanceModel
			byteLength: 0x2C
		}
	},
  environment: {
    ...
    rendering: {
	      ...
	      byteLength: 0x55
			...
			environment: {
				...
				offset: 0x00BE7EFE, // MapEnvironment
				byteLength: 0x38
			},
			river: {
				...
				offset: 0x00BE7F3B, // MapRiveradvance
				byteLength: 0x5B
			},
			under_water: {
				...
				offset: 0x00BE7F9B, // MapWaterAdvance
				byteLength: 0x32
			},
			zone: {
				...
				offset: 0x00BE7FD2, // MapZoneAdvance
				byteLength: 0x37
			},
			lights: {
			...
			terrain: {
				...
				offset: 0x00BE8084, // MapTrnUpdate
				byteLength: 0x35
			},
			cube_map: {
				...
				offset: 0x00BE80BE, // MapCubeMapAdvance
				byteLength: 0x44
			},
			props: {
				...
				offset: 0x00BE8107, // MapPropAdvance
				byteLength: 0x5E
			}
		},
    timeOfDayOriginal: new Buffer([0xF3, 0x0F, 0x11, 0x8E, 0xCC, 0x19, 0x00, 0x00, 0x5E, 0x5D, 0xC2, 0x04]),
    enableTimeOfDay: 0x00BF4B9C, // AFTER THIS -> F3 0F10 05 94220301   - movss xmm0,[Gw2.exe+FF2294]
    timeOfDay: 0x19CC,
    unknown: 0x1A20,
